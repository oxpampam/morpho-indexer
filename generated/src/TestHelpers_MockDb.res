...
@genType
and entities = {
    @as("CapChange") capChange: entityStoreOperations<Entities.CapChange.t>,
    @as("LPFlow") lPFlow: entityStoreOperations<Entities.LPFlow.t>,
    @as("Reallocation") reallocation: entityStoreOperations<Entities.Reallocation.t>,
    @as("Vault") vault: entityStoreOperations<Entities.Vault.t>,
    @as("VaultMarket") vaultMarket: entityStoreOperations<Entities.VaultMarket.t>,
    @as("VaultSnapshot") vaultSnapshot: entityStoreOperations<Entities.VaultSnapshot.t>,
  }
  ...
  let entities = {
      capChange: {
        makeStoreOperatorEntity(
          ...
          ~getStore=db => db->InMemoryStore.getInMemTable(
            ~entityConfig=module(Entities.CapChange)->Entities.entityModToInternal,
          )->(
            Utils.magic: InMemoryTable.Entity.t<Internal.entity> => InMemoryTable.Entity.t<
              Entities.CapChange.t,
            >
          ),
          ~getKey=({id}) => id,
        )
      ...
      lPFlow: {
        makeStoreOperatorEntity(
          ...
          ~makeMockDb=makeWithInMemoryStore,
          ~getStore=db => db->InMemoryStore.getInMemTable(
            ~entityConfig=module(Entities.LPFlow)->Entities.entityModToInternal,
          )->(
            Utils.magic: InMemoryTable.Entity.t<Internal.entity> => InMemoryTable.Entity.t<
              Entities.LPFlow.t,
            >
      ...
      reallocation: {
        makeStoreOperatorEntity(
          ...
          ~makeMockDb=makeWithInMemoryStore,
          ~getStore=db => db->InMemoryStore.getInMemTable(
            ~entityConfig=module(Entities.Reallocation)->Entities.entityModToInternal,
          )->(
            Utils.magic: InMemoryTable.Entity.t<Internal.entity> => InMemoryTable.Entity.t<
              Entities.Reallocation.t,
            >
          ),
          ~getKey=({id}) => id,
        )
      ...
      vault: {
        makeStoreOperatorEntity(
          ...
          ~makeMockDb=makeWithInMemoryStore,
          ~getStore=db => db->InMemoryStore.getInMemTable(
            ~entityConfig=module(Entities.Vault)->Entities.entityModToInternal,
          )->(
            Utils.magic: InMemoryTable.Entity.t<Internal.entity> => InMemoryTable.Entity.t<
              Entities.Vault.t,
            >
      ...
      vaultMarket: {
        makeStoreOperatorEntity(
          ...
          ~makeMockDb=makeWithInMemoryStore,
          ~getStore=db => db->InMemoryStore.getInMemTable(
            ~entityConfig=module(Entities.VaultMarket)->Entities.entityModToInternal,
          )->(
            Utils.magic: InMemoryTable.Entity.t<Internal.entity> => InMemoryTable.Entity.t<
              Entities.VaultMarket.t,
            >
          ),
          ~getKey=({id}) => id,
        )
      ...
      vaultSnapshot: {
        makeStoreOperatorEntity(
          ...
          ~makeMockDb=makeWithInMemoryStore,
          ~getStore=db => db->InMemoryStore.getInMemTable(
            ~entityConfig=module(Entities.VaultSnapshot)->Entities.entityModToInternal,
          )->(
            Utils.magic: InMemoryTable.Entity.t<Internal.entity> => InMemoryTable.Entity.t<
              Entities.VaultSnapshot.t,
            >
          ),
          ~getKey=({id}) => id,
        )
